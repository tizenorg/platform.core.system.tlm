...
{
  return (GDBusInterfaceInfo *) &_tlm_dbus_login_interface_info;
}
  ...
  GVariant *parameters)
{
  ...
  guint n;
  guint signal_id;
  info = (_ExtendedGDBusSignalInfo *) g_dbus_interface_info_lookup_signal ((GDBusInterfaceInfo *) &_tlm_dbus_login_interface_info, signal_name);
  if (info == NULL)
    return;
  ...
  const gchar *const *invalidated_properties)
{
  ...
  while (g_variant_iter_next (iter, "{&sv}", &key, NULL))
    {
      info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_tlm_dbus_login_interface_info, key);
  ...
  for (n = 0; invalidated_properties[n] != NULL; n++)
    {
      info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_tlm_dbus_login_interface_info, invalidated_properties[n]);
  ...
  gpointer user_data)
{
  ...
  GVariant *ret;
  ret = NULL;
  info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_tlm_dbus_login_interface_info, property_name);
  g_assert (info != NULL);
...
tlm_dbus_login_skeleton_dbus_interface_get_info (GDBusInterfaceSkeleton *skeleton)
{
  return tlm_dbus_login_interface_info ();
}

static GDBusInterfaceVTable *
tlm_dbus_login_skeleton_dbus_interface_get_vtable (GDBusInterfaceSkeleton *skeleton)
{
